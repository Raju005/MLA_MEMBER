...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.frmbut.Location = New System.Drawing.Point(280, 338)
        ...
        Me.Label8.Size = New System.Drawing.Size(272, 47)
        ...
        Me.Chk_SelectPayment.Size = New System.Drawing.Size(132, 47)
...
#End Region
    ...
    Private Sub JournalRegister_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Try
            ...
            If e.KeyCode = Keys.F2 Then
                Dim i As Integer
                For i = 0 To Chk_Store.Items.Count - 1
                    Chk_Store.SetItemChecked(i, True)
                Next
    ...
    Private Sub GridOperation()
        Try
            ...
            Dim Sqlstring, month, year As String
            Dim vNote As String
            Dim i, V As Double
            ...
            If Format(Dtp_FromVoucherDate.Value, "dd") = "01" Then
            Else
                MsgBox("From Date should be start from 1st")
                Exit Sub
            End If
            If Format(Dtp_FromVoucherDate.Value, "MM") = Format(Dtp_ToVoucherDate.Value, "MM") And Format(Dtp_FromVoucherDate.Value, "yyyy") = Format(Dtp_ToVoucherDate.Value, "yyyy") Then
            Else
                MsgBox("From Date and To Date should be in same month")
                Exit Sub
            End If
            strsql = "SELECT * FROM JOURNALENTRY WHERE vouchertype='MBILL' AND month(VOUCHERDATE)='" & Format(Dtp_FromVoucherDate.Value, "MM") & "' AND year(VOUCHERDATE)='" & Format(Dtp_FromVoucherDate.Value, "yyyy") & "' AND ISNULL(VOID,'')<>'Y' AND ISNULL(LOCK,'')='Y'"
            VCONN.getDataSet(strsql, "POSTED")
            If gdataset.Tables("POSTED").Rows.Count > 0 Then
                MsgBox("Month is Locked, can't post to accounts", MsgBoxStyle.Information, gcompanyname)
                Exit Sub
            End If
