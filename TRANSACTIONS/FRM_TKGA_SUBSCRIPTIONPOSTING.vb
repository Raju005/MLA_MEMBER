...
Public Class FRM_TKGA_SUBSCRIPTIONPOSTING
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FRM_TKGA_SUBSCRIPTIONPOSTING))
        ...
        Me.Label2.Text = "SUBSCRIPTION POSTING"
        '
        'Label8
        '
        ...
        Me.Name = "FRM_TKGA_SUBSCRIPTIONPOSTING"
...
#End Region
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_ok.Click
        ...
        'MONTHDATE = monthly
5:
        sqlString = "SELECT * FROM SUBSPOSTING WHERE cast(convert(varchar(11),BILLDATE,106) as datetime)='" & Format(BILLDATE1, "dd MMM yyyy") & "' AND ISNULL(VOID,'')<>'Y'"
        ...
        Try
            ...
            sqlString = "Exec  tp_subscriptionview '" & Format(MONTHDATE, "dd/MMM/yyyy") & "','" & TempString(0) & "'"
            ...
            sqlString = sqlString & " and isnull(VOID,'')<> 'Y' AND ISNULL(POSTINGFLAG,'')<>'Y'  group by billno,mcode,subsacctin,taxcode,period,subsdesc,subcd order by mcode,subsdesc"
            posting = gconnection.GetValues(sqlString)
            ...
            If posting.Rows.Count >= 1 Then
                ...
                sqlString1 = sqlString1 & " where billdate='" & Format(MONTHDATE, "dd/MMM/yyyy") & "' AND ISNULL(VOID,'')<>'Y'"
                ...
                'sqlString = sqlString & " from subsposting where billingbasis='" & Trim(cbo_BillingBasis.Text) & "'"
                sqlString = sqlString & " from subsposting where month(billdate)=" & monthly
                sqlString = sqlString & " and isnull(VOID,'')<> 'Y'   group by billno,mcode,subsacctin,taxcode,period,subsdesc,subcd order by mcode,subsdesc"
                posting = gconnection.GetValues(sqlString)
