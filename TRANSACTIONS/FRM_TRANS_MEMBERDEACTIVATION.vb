...
Public Class FRM_TRANS_MEMBERDEACTIVATION
    Dim boolchk As Boolean
    Dim SqlString As String
    Dim gconnection As New GlobalClass

    Private Sub FRM_TRANS_MEMBERDEACTIVATION_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        End If
    End Sub
    Private Sub FRM_TRANS_MEMBERDEACTIVATION_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub Status()
        Dim i As Integer
        Dim dt As DataTable
        SqlString = "SELECT distinct(name) FROM MemberStatusMaster where isnull(STATUS,'')='BLOCKED' and freeze<>'Y'and isnull(STATUS,'')<>''  "
        dt = gconnection.GetValues(SqlString)
        Dim Itration
        For Itration = 0 To (dt.Rows.Count - 1)
    ...
    Private Sub btn_add_Click(sender As Object, e As EventArgs) Handles btn_add.Click
        Try
            ...
            If btn_add.Text = "Update[F7]" Then
                ...
                If (txt_PresentStatus.Text = "ACTIVE" And cbo_NewStatus.Text = "DEFAULTER") Then
                ...
                ElseIf (txt_PresentStatus.Text = "ACTIVE" And cbo_NewStatus.Text = "ABSENTEE") Then
                    pstatus = txt_PresentStatus.Text
                ...
                ElseIf (txt_PresentStatus.Text = "DECEASED" And cbo_NewStatus.Text = "ACTIVE") Then
                    MessageBox.Show("Present Contact Administrator for this processing...!", MyCompanyName)
                    cbo_NewStatus.Text = ""
                    Exit Sub
                ...
                ElseIf (txt_PresentStatus.Text = "INACTIVE" And cbo_NewStatus.Text = "ACTIVE") Then
                    ...
                    cbo_NewStatus.Text = ""
                    Exit Sub
                ElseIf (txt_PresentStatus.Text = "INACTIVE" And cbo_NewStatus.Text = "SUSPENDED") Then
                    pstatus = txt_PresentStatus.Text
                    nstatus = cbo_NewStatus.Text
                    lbl_Effectivefrom.Visible = True
                    lbl_Effectiveto.Visible = True
            ...
            If btn_add.Text = "Add[F7]" Then
                ...
                SqlString = SqlString & Trim(txt_MemberName.Text) & "','" & Trim(pstatus) & "','" & Trim(nstatus) & "','" & Trim(Cbo_reasons1.Text.Replace("'", "")) & "',"
                ...
                SqlString = "insert into memdet(MEM_CODE,type0,type1,start_dt,end_dt,remarks,UPD_USER,UPD_DATE)"
            ...
            ElseIf btn_add.Text = "Update[F7]" Then
                ...
                SQLSTRING1 = "insert into Memberledger (MCODE,MNAME,NEWSTATUS,PRESENTSTATUS,REMARKS,EFFECTIVEFROM,EFFECTIVETO,ADD_USER,ADD_DATE) values('" & txt_MemberCode.Text & "','" & Trim(txt_MemberName.Text) & "','" & cbo_NewStatus.Text & "','" & txt_PresentStatus.Text & "','" & Trim(Cbo_reasons1.Text.Replace("'", "")) & "',Convert(datetime,'" & (dtp_EffectiveFrom.Text) & "',103),Convert(datetime,'" & (dtp_EffectiveTo.Text) & "',103),'" & gUsername & "',getdate())"
                ...
                If dtp_EffectiveFrom.Text <= gdate Then
                    ...
                    'gconnection.dataOperation(2, SQLSTRING2, "Memberledger")
    ...
    Public Sub checkValidation()
        ...
        If Trim(Cbo_reasons1.Text) = "" Then
            MessageBox.Show("Reasons can't be blank ", MyCompanyName, MessageBoxButtons.OK, MessageBoxIcon.Error)
            cbo_NewStatus.Focus()
            Exit Sub
        End If
            ...
            If txt_MemberCode.Text <> "" Then
                ...
                If Statusconv.Rows.Count > 0 Then
                    ...
                    If Statusconv.Rows.Count > 0 Then
                        ...
                        Me.btn_add.Text = "Add New[F5]"
                    End If
                    Me.btn_add.Text = "Update[F5]"
                Else
                    strSQL = " SELECT isnull(mname,'') as mname,isnull(curentstatus,'') as curentstatus,isnull(Convert(datetime,doj,103),'') as doj FROM memberMASTER WHERE mcode='" & Trim(Me.txt_MemberCode.Text) & "'"
                    Statusconv = gconnection.GetValues(strSQL)
                    If Statusconv.Rows.Count > 0 Then
                        ...
                        'Me.Cbo_reasons.Text = "No Details availabel in Data Base"
    ...
    Private Sub BTN_DOS_Click(sender As Object, e As EventArgs) Handles BTN_DOS.Click
        ...
        gheader = " MEMBER DEACTIVATION DETAILS "
    ...
    Private Sub BTN_WINDOWS_Click(sender As Object, e As EventArgs) Handles BTN_WINDOWS.Click
        ...
        If gdataset.Tables("VIEW_MEMBERLEDGER").Rows.Count > 0 Then
            ...
            txtobj1.Text = UCase(" MEMBER DEACTIVATION ")
