...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(BULK_CR))
        ...
        Me.Label10.Text = "BULK CREDIT"
        '
        'SSGrid_AccountSetup
        '
        Me.SSGrid_AccountSetup.DataSource = Nothing
        Me.SSGrid_AccountSetup.Location = New System.Drawing.Point(79, 289)
        ...
        Me.SSGrid_AccountSetup.Size = New System.Drawing.Size(747, 379)
        ...
        Me.frmbut.Location = New System.Drawing.Point(862, 165)
        Me.frmbut.Name = "frmbut"
        Me.frmbut.Size = New System.Drawing.Size(141, 301)
        ...
        Me.CmdDelete.Location = New System.Drawing.Point(0, 244)
        ...
        Me.cmdexit.Location = New System.Drawing.Point(-1, 188)
        ...
        Me.GroupBox1.Location = New System.Drawing.Point(179, 276)
        Me.GroupBox1.Name = "GroupBox1"
        Me.GroupBox1.Size = New System.Drawing.Size(677, 407)
        ...
        Me.GroupBox2.Location = New System.Drawing.Point(353, 28)
        ...
        Me.Txt_VoucherNo.Location = New System.Drawing.Point(55, 11)
        ...
        Me.Cmd_VoucherNoHelp.Location = New System.Drawing.Point(246, 10)
        ...
        Me.lbl_void.Location = New System.Drawing.Point(390, 9)
        Me.lbl_void.Name = "lbl_void"
        Me.lbl_void.Size = New System.Drawing.Size(144, 22)
        Me.lbl_void.TabIndex = 926
        ...
        Me.Cmd_FillData.Location = New System.Drawing.Point(27, 11)
        Me.Cmd_FillData.Name = "Cmd_FillData"
        Me.Cmd_FillData.Size = New System.Drawing.Size(82, 22)
        Me.Cmd_FillData.TabIndex = 927
        ...
        Me.GroupBox3.Location = New System.Drawing.Point(225, 101)
        Me.GroupBox3.Name = "GroupBox3"
        Me.GroupBox3.Size = New System.Drawing.Size(381, 178)
        Me.GroupBox3.TabIndex = 929
        ...
        'Txt_taxcode
        '
        Me.Txt_taxcode.Location = New System.Drawing.Point(76, 93)
        Me.Txt_taxcode.Name = "Txt_taxcode"
        Me.Txt_taxcode.Size = New System.Drawing.Size(100, 20)
        Me.Txt_taxcode.TabIndex = 935
        '
        'Label5
        '
        ...
        'Txt_reason
        '
        Me.Txt_reason.Location = New System.Drawing.Point(75, 117)
        ...
        Me.GroupBox4.Location = New System.Drawing.Point(612, 104)
        Me.GroupBox4.Name = "GroupBox4"
        Me.GroupBox4.Size = New System.Drawing.Size(244, 175)
        Me.GroupBox4.TabIndex = 940
...
#End Region
    ...
    Private Sub CmdView_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdView.Click
        ...
        sqlstring = " select *  FROM BULKCREDIT WHERE VOUCHERNO='" & Trim(Txt_VoucherNo.Text) & "' "
        gconnection.getDataSet(sqlstring, "BULKCREDIT")
        If gdataset.Tables("BULKCREDIT").Rows.Count > 0 Then
            ''sqlstring = sqlstring & " ORDER BY mcode "
            Call Viewer.GetDetails1(sqlstring, "BULKCREDIT", r)
    ...
    Private Sub autogenerate()
        ...
        Try
            ...
            'sqlstring = "SELECT MAX(SUBSTRING(VOUCHERNO,8,6)) FROM journalentry WHERE VoucherType='CRN' AND DESCRIPTION='BULKCREDIT'"

            sqlstring = "SELECT MAX(SUBSTRING(VOUCHERNO,11,7)) FROM journalentry WHERE VoucherType='CRN' AND DESCRIPTION='BULKCREDIT' AND VOUCHERNO NOT LIKE 'BLK%' "
            ...
            If docprefixreader.Read Then
                ...
                If docprefixreader(0) Is System.DBNull.Value Then
                    Txt_VoucherNo.Text = "BLKCRN" & "/000001/" & financalyear
                    docprefixreader.Close()
                    gcommand.Dispose()
                    gconnection.closeconnection()
                Else
                    Txt_VoucherNo.Text = "BLKCRN" & "/" & Format(docprefixreader(0) + 1, "000000") & "/" & financalyear
                    docprefixreader.Close()
                    gcommand.Dispose()
                    gconnection.closeconnection()
                End If
    ...
    Private Sub CmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdAdd.Click
        ...
        ''    Exit Sub
        ''End If
        If Txt_amount.Text = "" Or Txt_amount.Text = 0 Then
            MessageBox.Show("Amount should not be blank", "Grid Validation", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
            Exit Sub
            Txt_amount.Focus()
        End If
        ...
        Try
            ...
            With SSGrid_AccountSetup
                ...
                For I = 1 To .DataRowCnt
                    ...
                    sqlstring = sqlstring & " 'BC/' + '" & MCODE & "' + '/' + '" & Trim(Mid(Txt_VoucherNo.Text, 8, 6)) & "','" & Trim(Txt_VoucherNo.Text) & "','" & Trim(Dtp_VoucherDate.Text) & "','CRN','CRN','" & SDRSCOD & "','" & SDRSDES & "','" & MCODE & "','" & MNAME & "','CREDIT','" & Val(AMOUNT) & "','N','" & gUsername & " ', '" & Format(Now, "dd-MMM-yyyy HH:mm") & "','BULKCREDIT','" + ACDHEAD + "')"
                    ...
                    sqlstring = sqlstring & " values('BC/' + '" & MCODE & "' + '/' + '" & Trim(Mid(Txt_VoucherNo.Text, 8, 6)) & "','" & Trim(Txt_VoucherNo.Text) & "','" & Trim(Dtp_VoucherDate.Text) & "','CRN','CRN','" & Txt_oppgl.Text & "','','','','DEBIT','" & Val(AMOUNT) & "','N','" & gUsername & " ', '" & Format(Now, "dd-MMM-yyyy HH:mm") & "','BULKCREDIT','" & MCODE & "')"
                    ReDim Preserve INSERT(INSERT.Length)
                    INSERT(INSERT.Length - 1) = sqlstring
                    ...
                    sqlstring = "Insert into BULKCREDIT (voucherno,voucherdate,VoucherCategory,VoucherType,accountcode,accountcodedesc,slcode,sldesc,creditdebit,amount,void,adduserid,adddatetime,Description,CHARGECODE,reason) values("
                    sqlstring = sqlstring & " '" & Trim(Txt_VoucherNo.Text) & "','" & Trim(Dtp_VoucherDate.Text) & "','CRN','CRN','" & ACDHEAD & "','" & ACDESC & "','" & MCODE & "','" & MNAME & "','DEBIT','" & Val(AMOUNT) & "','N','" & gUsername & " ', '" & Format(Now, "dd-MMM-yyyy HH:mm") & "','BULKCREDIT','" + ACDHEAD + "','" & reason & "')"
                    ReDim Preserve INSERT(INSERT.Length)
                    INSERT(INSERT.Length - 1) = sqlstring
                    ...
                    If gdataset.Tables("ITEMTYPEMASTER").Rows.Count > 0 Then
                        For J = 0 To gdataset.Tables("ITEMTYPEMASTER").Rows.Count - 1
                            ...
                            If Tpercent <> "0" Or Tpercent <> "0.00" Then
                                ...
                                sqlstring = sqlstring & "values('BC/' + '" & MCODE & "' + '/' + '" & Trim(Mid(Txt_VoucherNo.Text, 8, 6)) & "','" & Trim(Txt_VoucherNo.Text) & "','" & Trim(Dtp_VoucherDate.Text) & "','CRN','CRN','" & SDRSCOD & "','" & SDRSDES & "','" & MCODE & "','" & MNAME & "','CREDIT','" & Val(TAXAMOUNT) & "','N','" & gUsername & " ', '" & Format(Now, "dd-MMM-yyyy HH:mm") & "','BULKCREDIT','" & ACCOUNT & "')"
                                ReDim Preserve INSERT(INSERT.Length)
                                INSERT(INSERT.Length - 1) = sqlstring
                                ...
                                sqlstring = sqlstring & "values('BC/' + '" & MCODE & "' + '/' + '" & Trim(Mid(Txt_VoucherNo.Text, 8, 6)) & "','" & Trim(Txt_VoucherNo.Text) & "','" & Trim(Dtp_VoucherDate.Text) & "','CRN','CRN','" & ACCOUNT & "','" & ACCOUNTDESC & "','','','DEBIT','" & Val(TAXAMOUNT) & "','N','" & gUsername & " ', '" & Format(Now, "dd-MMM-yyyy HH:mm") & "','BULKCREDIT','')"
                                ReDim Preserve INSERT(INSERT.Length)
                                INSERT(INSERT.Length - 1) = sqlstring
    ...
    Private Sub Txt_VoucherNofill()

        Dim sqlstring As String

        sqlstring = " Select ISNULL(VOUCHERNO,'')AS VOUCHERNO,ISNULL(VOUCHERDATE,'')AS VOUCHERDATE,ISNULL(VOUCHERDATE,'')AS VOUCHERDATE,ISNULL(SLCODE,'')AS SLCODE,ISNULL(SLDESC,'')AS SLDESC,ISNULL(AMOUNT,0)AS AMOUNT, ISNULL(Description,'')AS Description,ISNULL(VOID,'') AS VOID,ISNULL(ADDDATETIME,'') AS ADDDATETIME,ISNULL(FREEZEDATETIME,'') AS FREEZEDATETIME From JournalEntry Where VOUCHERNO='" & Txt_VoucherNo.Text & "'  and VoucherType='" & Trim(Txt_VoucherNo.Text) & "' AND CREDITDEBIT='DEBIT' AND ISNULL(TAXFLAG,'')<>'Y'"
        gconnection.getDataSet(sqlstring, "JournalEntry")
        If gdataset.Tables("JournalEntry").Rows.Count > 0 Then
            'Txt_VoucherNo.Text = gdataset.Tables("JournalEntry").Rows(0).Item("VOUCHERNO")
            'Dtp_VoucherDate.Text = gdataset.Tables("JournalEntry").Rows(0).Item("VOUCHERDATE")
            'txt_mcode.Text = gdataset.Tables("JournalEntry").Rows(0).Item("SLCODE")
            'txt_name.Text = gdataset.Tables("JournalEntry").Rows(0).Item("SLDESC")
            'Txt_Amt.Text = gdataset.Tables("JournalEntry").Rows(0).Item("AMOUNT")
            'Txt_Naration.Text = gdataset.Tables("JournalEntry").Rows(0).Item("Description")
            'sqlstring1 = " Select  ISNULL(AccountCode,'')AS AccountCode,ISNULL(AccountcodeDesc,'')AS AccountcodeDesc   From JournalEntry Where VOUCHERNO='" & Txt_VoucherNo.Text & "'  and VoucherType='" & Trim(Txt_VoucherPrefix.Text) & "' AND CREDITDEBIT='CREDIT'"
            'gconnection.getDataSet(sqlstring1, "JournalEntry1")
            'Txt_code.Text = gdataset.Tables("JournalEntry1").Rows(0).Item("AccountCode")
            'Txt_Codedesc.Text = gdataset.Tables("JournalEntry1").Rows(0).Item("AccountcodeDesc")
            'Txt_VoucherNo.ReadOnly = True
            'Dtp_VoucherDate.Enabled = False
            'txt_mcode.ReadOnly = True
            'sqlstring1 = " Select  ISNULL(SUM(AMOUNT),0) AS AMOUNT  From JournalEntry Where VOUCHERNO='" & Txt_VoucherNo.Text & "'  and VoucherType='" & Trim(Txt_VoucherPrefix.Text) & "' AND CREDITDEBIT='DEBIT' AND ISNULL(TAXFLAG,'')='Y'"
            'gconnection.getDataSet(sqlstring1, "JournalEntry1")
            'If gdataset.Tables("JournalEntry1").Rows.Count > 0 Then
            '    txt_tax.Text = gdataset.Tables("JournalEntry1").Rows(0).Item("AMOUNT")
            'End If
    ...
    Private Sub CmdDelete_Click_1(sender As Object, e As EventArgs) Handles CmdDelete.Click
        ...
        If gdataset.Tables("bill").Rows.Count > 0 Then
            ...
            Else
                ...
                VCONN.ExcuteStoreProcedure(ssql)
                ssql = "update BULKCREDIT set void='Y' where voucherno='" & Trim(Me.Txt_VoucherNo.Text) & "'"
                VCONN.ExcuteStoreProcedure(ssql)
                MsgBox("TRANSACTION COMPLETED SUCCESSFULY")
    ...
    Private Sub Txt_oppgl_Validated(sender As Object, e As EventArgs) Handles Txt_oppgl.Validated
        Call TXTACCODE(sender, e)
    End Sub
