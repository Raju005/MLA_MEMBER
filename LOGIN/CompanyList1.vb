...
#Region "Windows Form Designer generated code "
	...
	<System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'ImgQuit1
        '
        Me.ImgQuit1.Image = Global.Bengal_MemberMaster.My.Resources.Resources._Exit
        Me.ImgQuit1.Location = New System.Drawing.Point(777, 256)
        ...
        'ImgQuit2
        '
        Me.ImgQuit2.Image = Global.Bengal_MemberMaster.My.Resources.Resources._Exit
        Me.ImgQuit2.Location = New System.Drawing.Point(777, 256)
        ...
        'fgrdCompanyList
        '
        Me.fgrdCompanyList.Location = New System.Drawing.Point(186, 65)
        ...
        Me.fgrdCompanyList.Size = New System.Drawing.Size(506, 206)
        ...
        Me.ImgDel1.Location = New System.Drawing.Point(768, 202)
        ...
        Me.ImgDel2.Location = New System.Drawing.Point(768, 201)
        ...
        Me.ImgMod1.Location = New System.Drawing.Point(768, 160)
        ...
        Me.ImgMod2.Location = New System.Drawing.Point(768, 160)
        ...
        Me.ImgAdd1.Location = New System.Drawing.Point(768, 120)
        ...
        Me.ImgAdd2.Location = New System.Drawing.Point(768, 120)
...
#End Region 
	...
	Private Sub fgrdCompanyList_Click1()
		...
		If Trim(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 0)) <> "" Then
            ...
            gvoucherdate = gFinancialyearStart
            ...
            gfinnyrend = gFinancialyearEnding
        ...
        If ds.Tables(0).Rows.Count > 0 Then
            ...
            For LoopIndex = 0 To ds.Tables(0).Rows.Count - 1
                With ds.Tables(0).Rows(LoopIndex)
                    ...
                    '    fgrdCompanyList.set_TextMatrix(LoopIndex + 1, 8, Trim(.Item("Phone1") & ""))
                    'End If

                    If .IsNull("PINCODE") = False Then
                    ...
                    '    fgrdCompanyList.set_TextMatrix(LoopIndex + 1, 9, Trim(.Item("fax") & ""))
                    'End If

                    'If .IsNull("PINCODE") = False Then
                    '    fgrdCompanyList.set_TextMatrix(LoopIndex + 1, 10, Trim(.Item("PINCODE") & ""))
                    'End If
    ...
    Private Sub ImgPro1_Move(sender As Object, e As EventArgs) Handles ImgPro1.Move
