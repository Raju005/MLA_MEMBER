...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Button3.Font = New System.Drawing.Font("Arial", 9.75!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(178, Byte))
        ...
        Me.Button2.Font = New System.Drawing.Font("Arial", 9.75!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(178, Byte))
        ...
        Me.TxtPassWord.Font = New System.Drawing.Font("Batang", 9.75!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.TxtUserName.Font = New System.Drawing.Font("Batang", 9.75!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.Label4.Size = New System.Drawing.Size(320, 128)
...
#End Region
    ...
    Private Sub GetMasterConnection()
        ...
        If Trim(gserver) <> "" Then
            sqlcon = "Data Source=" & gserver & ";Persist Security Info=False;User ID=" & SQL_UserName & ";Pwd=" & SQL_Password & ";Initial Catalog=Master"
        ...
        Else
            sqlcon = "Data Source=(Local);Persist Security Info=False;User ID=" & SQL_UserName & ";Pwd=" & SQL_Password & ";Initial Catalog=Master"
        ...
        Try
            ...
            '    sql = "Select * from UserAdmin where username='" & Trim(UCase(TxtUserName.Text)) & "' and userpassword ='" & Trim(GetPass(UCase(TxtPassWord.Text))) & "' and MainGroup='" & gPackagename & "' and Category='U'"
            'Else
            sql = "Select * from UserAdmin where username='" & Trim(UCase(TxtUserName.Text)) & "' and userpassword ='" & Trim(GetPass(UCase(TxtPassWord.Text))) & "'"
            'End If
    ...
    Public Sub GetServer()
        ...
        Try
            ServerConn.Open()
            ssql = "SELECT SERVER, USERNAME, PASSWORD,PDF FROM DBSKEY"
            ...
            If getserver.Tables(0).Rows.Count > 0 Then
                ...
                gpdf = Trim(getserver.Tables(0).Rows(0).Item(3) & "")
                'End
            Else
    ...
    Private Sub TxtUserName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtUserName.KeyPress
        ...
        End If
    End Sub
    Private Sub Cbo_Usertype_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
