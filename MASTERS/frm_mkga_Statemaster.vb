...
Public Class frm_mkga_Statemaster
    Dim boolchk As Boolean
    Dim gconnection As New GlobalClass
    Dim sqlstring As String
    Dim vSeqNo As Double

    Private Sub frm_mkga_Statemaster_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
        ...
        End Try
    End Sub
    Private Sub frm_mkga_Statemaster_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'Resize_Form()
    ...
    Private Sub txt_codefill()
        Try
            ...
            If Txtcode.Text <> "" Then
                Sqlstr = " SELECT ISNULL(CODE,'') AS CODE,ISNULL(NAME,'') AS NAME,ISNULL(COUNTRY,'') AS COUNTRY ,FREEZE FROM Tbl_stateMaster WHERE CODE='" & Trim(Txtcode.Text) & "'"
            ...
            Dim ssql As String
            ssql = " Select Freeze,voiddate  From Tbl_StateMaster Where Code='" & Txtcode.Text & "'"
            gconnection.getDataSet(ssql, "Master")
            If gdataset.Tables("Master").Rows.Count > 0 Then
                If gdataset.Tables("Master").Rows(0).Item("Freeze") = "Y" Then
                    lbl_freeze.Visible = True
                    Me.lbl_freeze.Text = "Record Voided  On "
                    lbl_freeze.Text = lbl_freeze.Text & Format(gdataset.Tables("Master").Rows(0).Item("voiddate"), "dd-MMM-yyyy")
    ...
    Private Sub cmdMasterHelp_Click(sender As Object, e As EventArgs) Handles cmdMasterHelp.Click
        Dim vform As New LIST_OPERATION1
        gSQLString = "SELECT ISNULL(CODE,'') AS CODE,ISNULL(NAME,'') AS NAME,ISNULL(COUNTRY,'') AS COUNTRY  FROM Tbl_StateMaster"
        M_WhereCondition = " "
        vform.Field = "CODE,NAME"
        vform.vCaption = "STATE MASTER HELP "
    ...
    Private Sub btn_addnew_Click(sender As Object, e As EventArgs) Handles btn_addnew.Click
        If btn_addnew.Text = "Add [F7]" Then
            ...
            sqlstring = "Insert into Tbl_StateMaster"
            sqlstring = sqlstring + "(Code,Name,Freeze,country,AddUser,Adddatetime)"
            sqlstring = sqlstring + "values('" + Trim(Txtcode.Text) + "','" + Trim(txtName.Text) + "', 'N','" + Trim(Cbo_PCountry.Text) + "','" & gUsername & " ', '" & Format(Now, "dd-MMM-yyyy HH:mm") & "')"
            gconnection.dataOperation(1, sqlstring, "Tbl_StateMaster")
        ...
        ElseIf btn_addnew.Text = "Update [F7]" Then
            ...
            If Mid(Me.btn_addnew.Text, 1, 1) = "U" Then
                ...
                End If
            End If
            sqlstring = "Update Tbl_StateMaster SET "
            sqlstring = sqlstring + "Name='" + Trim(txtName.Text) + "',Country ='" + Trim(Cbo_PCountry.Text) + "',Freeze= 'N',UPD_USER='" & gUsername & " ', UPD_DATE='" & Format(Now, "dd-MMM-yyyy HH:mm") & "' Where Code='" + Trim(Txtcode.Text) + "'"
            gconnection.dataOperation(2, sqlstring, "Tbl_StateMaster")
    ...
    Private Sub btn_freeze_Click(sender As Object, e As EventArgs) Handles btn_freeze.Click
        ...
        If Mid(Me.btn_freeze.Text, 1, 1) = "V" And Mid(Me.btn_addnew.Text, 1, 1) = "U" Then
            sqlstring = "UPDATE  Tbl_StateMaster "
            ...
            gconnection.dataOperation(3, sqlstring, "Tbl_StateMaster")
        ...
        ElseIf Mid(Me.btn_freeze.Text, 1, 1) = "U" And Mid(Me.btn_addnew.Text, 1, 1) = "U" Then
            ...
            'sqlstring = sqlstring & " WHERE Code = '" & Trim(Txtcode.Text) & "'"
            'gconnection.dataOperation(4, sqlstring, "Tbl_StateMaster")
    ...
    Private Sub btn_authorize_Click(sender As Object, e As EventArgs) Handles btn_authorize.Click
        ...
        End If
        If USERT = 1 Then
            SSQLSTR2 = " SELECT * FROM TBL_STATEMASTER WHERE ISNULL(AUTHORISED,'')<>'Y' AND ISNULL(AUTHORISE_USER1,'')=''"
                ...
                If gdataset.Tables("AUTHORIZE").Rows.Count > 0 Then
                    ...
                    If gdataset.Tables("AUTHORIZELEVEL").Rows.Count > 0 Then
                        ...
                        If gdataset.Tables("AUTHORIZEL").Rows.Count > 0 Then
                            ...
                            Call VIEW1.LOADGRID(gdataset.Tables("AUTHORIZEL"), False, Me, "UPDATE TBL_STATEMASTER set  ", "Code", gdataset.Tables("AUTHORIZELEVEL").Rows(0).Item("AUTHORIZELEVEL"), 1, 1)
                        End If
                    Else
            ...
            End If
        ElseIf USERT = 2 Then
            SSQLSTR2 = " SELECT * FROM TBL_STATEMASTER WHERE ISNULL(AUTHORISED,'')<>'Y' AND ISNULL(AUTHORISE_USER2,'')='' AND ISNULL(AUTHORISE_USER1,'')<>''"
            gconnection.getDataSet(SSQLSTR2, "AUTHORIZEL")
            If gdataset.Tables("AUTHORIZEL").Rows.Count > 0 Then
                gSQLString = "  SELECT * FROM AUTHORIZE WHERE MODULENAME='MEMBER' AND FORMNAME='" & GmoduleName & "' AND '" & gUsername & "' IN(SELECT AUTH2USER1 FROM AUTHORIZE  WHERE MODULENAME='MEMBER' AND FORMNAME='" & GmoduleName & "' UNION ALL SELECT AUTH2USER2 FROM AUTHORIZE WHERE MODULENAME='MEMBER' AND FORMNAME='" & GmoduleName & "')"
                ...
                If gdataset.Tables("AUTHORIZE1").Rows.Count > 0 Then
                    ...
                    If gdataset.Tables("AUTHORIZELEVEL").Rows.Count > 0 Then
                        ...
                        If gdataset.Tables("AUTHORIZEL").Rows.Count > 0 Then
                            ...
                            Call VIEW1.LOADGRID(gdataset.Tables("AUTHORIZEL"), False, Me, "UPDATE TBL_STATEMASTER set  ", "Code", gdataset.Tables("AUTHORIZELEVEL").Rows(0).Item("AUTHORIZELEVEL"), 2, 1)
                        End If
                    End If
                End If
            End If
        ElseIf USERT = 3 Then
            SSQLSTR2 = " SELECT * FROM TBL_STATEMASTER WHERE ISNULL(AUTHORISED,'')<>'Y' AND ISNULL(AUTHORISE_USER3,'')=''AND ISNULL(AUTHORISE_USER1,'')<>''  AND ISNULL(AUTHORISE_USER2,'')<>''"
            gconnection.getDataSet(SSQLSTR2, "AUTHORIZEL")
            If gdataset.Tables("AUTHORIZEL").Rows.Count > 0 Then
                gSQLString = "  SELECT * FROM AUTHORIZE WHERE MODULENAME='MEMBER' AND FORMNAME='" & GmoduleName & "' AND '" & gUsername & "' IN(SELECT AUTH3USER1 FROM AUTHORIZE  WHERE MODULENAME='MEMBER' AND FORMNAME='" & GmoduleName & "' UNION ALL SELECT AUTH3USER2 FROM AUTHORIZE WHERE MODULENAME='MEMBER' AND FORMNAME='" & GmoduleName & "')"
                ...
                If gdataset.Tables("AUTHORIZE2").Rows.Count > 0 Then
                    ...
                    gconnection.getDataSet(gSQLString, "AUTHORIZELEVEL")
                    If gdataset.Tables("AUTHORIZELEVEL").Rows.Count > 0 Then
                        SSQLSTR2 = " SELECT * FROM TBL_STATEMASTER WHERE ISNULL(AUTHORISED,'')<>'Y' AND ISNULL(AUTHORISE_USER3,'')=''"
                        gconnection.getDataSet(SSQLSTR2, "AUTHORIZEL")
                        If gdataset.Tables("AUTHORIZEL").Rows.Count > 0 Then
                            Dim VIEW1 As New AUTHORISATION
                            VIEW1.Show()
                            VIEW1.DTAUTH.DataSource = Nothing
                            VIEW1.DTAUTH.Rows.Clear()
                            Call VIEW1.LOADGRID(gdataset.Tables("AUTHORIZEL"), False, Me, "UPDATE TBL_STATEMASTER set  ", "Code", gdataset.Tables("AUTHORIZELEVEL").Rows(0).Item("AUTHORIZELEVEL"), 3, 1)
                        End If
                    End If
                End If
            Else
    ...
    Private Sub browse_Click(sender As Object, e As EventArgs) Handles browse.Click
        ...
        STRQUERY = "SELECT code,* FROM TBl_stateMASTER"
        ...
        Call VIEW1.LOADGRID(gdataset.Tables("authorize"), True, gcompanyname, "SELECT * FROM TBl_stateMASTER", "code", 1, Me.Txtcode)
        'VIEW1.Hide()
        'VIEW1.ShowDialog(Me)
    ...
    Private Sub CMD_DOS_Click(sender As Object, e As EventArgs) Handles CMD_DOS.Click
        ...
        gheader = "STATE MASTER VIEW "
        If Txtcode.Text.Length > 0 Then
            tables = " FROM Tbl_StateMaster where CODE = '" & Trim(Txtcode.Text) & "'"
        Else
            tables = " FROM Tbl_StateMaster"
        End If
        ...
        row = New String() {"Name", "15"}
        reportdesign.DataGridView1.Rows.Add(row)
        row = New String() {"Country", "28"}
        reportdesign.DataGridView1.Rows.Add(row)
    ...
    Private Sub CMD_WINDOWS_Click(sender As Object, e As EventArgs) Handles CMD_WINDOWS.Click
        ...
        sqlstring = "select * from view_statemaster "
        If Txtcode.Text = "" Then
            sqlstring = sqlstring & ""
        Else
            sqlstring = sqlstring & " WHERE Code ='" & Txtcode.Text & "' "
        End If
        Dim r As New Cry_Statemaster
        gconnection.getDataSet(sqlstring, "view_statemaster")
        If gdataset.Tables("view_statemaster").Rows.Count > 0 Then
            Viewer.TableName = "view_statemaster"
            Call Viewer.GetDetails(sqlstring, "view_statemaster", r)
