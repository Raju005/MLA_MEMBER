...
Public Class ReportDesigner
    ...
    Private Sub ReportDesigner_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
            If e.KeyCode = Keys.F2 Then
                If CHK_SELECT.Checked = True Then
                    CHK_SELECT.CheckState = CheckState.Unchecked
                Else
                    CHK_SELECT.CheckState = CheckState.Checked
                End If
                Exit Sub
            End If

            If e.KeyCode = Keys.F9 Then
                BUT_GEN_VIEW_Click(sender, e)
            End If

            If e.KeyCode = Keys.F10 Then
                BUT_GV_PRINT_Click(sender, e)
            End If
