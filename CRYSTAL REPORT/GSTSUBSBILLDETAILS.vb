...
Public Class GSTSUBSBILLDETAILS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengal_MemberMaster.GSTSUBSBILLDETAILS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGSTSUBSBILLDETAILS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GSTSUBSBILLDETAILS = New GSTSUBSBILLDETAILS()
        rpt.Site = Me.Site
        Return rpt
    End Function
