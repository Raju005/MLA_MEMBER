...
Public Class Cry_Memberledger
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengal_MemberMaster.Cry_Memberledger.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Memberledger
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Memberledger = New Cry_Memberledger()
        rpt.Site = Me.Site
        Return rpt
    End Function
