...
Public Class Cry_Creditadvice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengal_MemberMaster.Cry_Creditadvice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Creditadvice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Creditadvice = New Cry_Creditadvice()
        rpt.Site = Me.Site
        Return rpt
    End Function
