...
Public Class Cry_Countrymaster1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengal_MemberMaster.Cry_Countrymaster.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class CachedCry_Countrymaster1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Countrymaster = New Cry_Countrymaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
