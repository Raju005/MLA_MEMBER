...
Public Class Cry_MEMBERDOW
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengal_MemberMaster.Cry_MEMBERDOW.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_MEMBERDOW
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_MEMBERDOW = New Cry_MEMBERDOW()
        rpt.Site = Me.Site
        Return rpt
    End Function
