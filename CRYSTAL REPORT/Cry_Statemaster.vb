...
Public Class Cry_Statemaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengal_MemberMaster.Cry_Statemaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Statemaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Statemaster = New Cry_Statemaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
