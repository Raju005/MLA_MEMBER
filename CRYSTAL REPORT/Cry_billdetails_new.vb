...
Public Class Cry_billdetails_new
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Cry_billdetails_new.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengal_MemberMaster.Cry_billdetails_new.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Parameter() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCry_billdetails_new
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_billdetails_new = New Cry_billdetails_new()
        rpt.Site = Me.Site
        Return rpt
    End Function
