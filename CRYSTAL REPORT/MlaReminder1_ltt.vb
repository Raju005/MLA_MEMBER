...
Public Class MlaReminder1_ltt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengal_MemberMaster.MlaReminder1_ltt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMlaReminder1_ltt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MlaReminder1_ltt = New MlaReminder1_ltt()
        rpt.Site = Me.Site
        Return rpt
    End Function
