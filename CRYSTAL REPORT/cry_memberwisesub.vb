...
Public Class cry_memberwisesub
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengal_MemberMaster.cry_memberwisesub.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcry_memberwisesub
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cry_memberwisesub = New cry_memberwisesub()
        rpt.Site = Me.Site
        Return rpt
    End Function
