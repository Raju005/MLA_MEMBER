...
Public Class Cry_MEMBERACTDEACT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengal_MemberMaster.Cry_MEMBERACTDEACT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_MEMBERACTDEACT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_MEMBERACTDEACT = New Cry_MEMBERACTDEACT()
        rpt.Site = Me.Site
        Return rpt
    End Function
