...
Public Class CCLCry_Det_MLA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengal_MemberMaster.CCLCry_Det_MLA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCCLCry_Det_MLA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CCLCry_Det_MLA = New CCLCry_Det_MLA()
        rpt.Site = Me.Site
        Return rpt
    End Function
