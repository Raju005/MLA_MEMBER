...
Public Class Cry_categorymaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengal_MemberMaster.Cry_categorymaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_categorymaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_categorymaster = New Cry_categorymaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
