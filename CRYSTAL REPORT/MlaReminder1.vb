...
Public Class CCLReminder1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengal_MemberMaster.CCLReminder1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCCLReminder1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CCLReminder1 = New CCLReminder1()
        rpt.Site = Me.Site
        Return rpt
    End Function
