...
Public Class Cry_Commitee
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengal_MemberMaster.Cry_Commitee.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Commitee
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Commitee = New Cry_Commitee()
        rpt.Site = Me.Site
        Return rpt
    End Function
