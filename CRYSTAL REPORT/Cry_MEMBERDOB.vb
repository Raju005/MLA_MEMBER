...
Public Class Cry_MEMBERDOB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengal_MemberMaster.Cry_MEMBERDOB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_MEMBERDOB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_MEMBERDOB = New Cry_MEMBERDOB()
        rpt.Site = Me.Site
        Return rpt
    End Function
