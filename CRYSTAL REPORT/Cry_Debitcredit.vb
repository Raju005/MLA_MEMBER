...
Public Class Cry_Debitcredit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengal_MemberMaster.Cry_Debitcredit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Debitcredit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Debitcredit = New Cry_Debitcredit()
        rpt.Site = Me.Site
        Return rpt
    End Function
