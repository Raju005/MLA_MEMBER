...
Public Class Cry_Citymaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengal_MemberMaster.Cry_Citymaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Citymaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Citymaster = New Cry_Citymaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
