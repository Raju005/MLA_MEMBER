...
Public Class Cry_Allcatoutlet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengal_MemberMaster.Cry_Allcatoutlet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Allcatoutlet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Allcatoutlet = New Cry_Allcatoutlet()
        rpt.Site = Me.Site
        Return rpt
    End Function
