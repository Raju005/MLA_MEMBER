...
Public Class Cry_dependency
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengal_MemberMaster.Cry_dependency.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_dependency
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_dependency = New Cry_dependency()
        rpt.Site = Me.Site
        Return rpt
    End Function
