...
Public Class Cry_Memberledger1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengal_MemberMaster.Cry_Memberledger1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Memberledger1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Memberledger1 = New Cry_Memberledger1()
        rpt.Site = Me.Site
        Return rpt
    End Function
