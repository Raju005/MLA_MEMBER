...
Public Class MlaReminder1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengal_MemberMaster.MlaReminder1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMlaReminder1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MlaReminder1 = New MlaReminder1()
        rpt.Site = Me.Site
        Return rpt
    End Function
