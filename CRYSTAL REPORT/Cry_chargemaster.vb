...
Public Class Cry_chargemaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengal_MemberMaster.Cry_chargemaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_chargemaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_chargemaster = New Cry_chargemaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
