...
Public Class Cry_Titlemaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengal_MemberMaster.Cry_Titlemaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Titlemaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Titlemaster = New Cry_Titlemaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
