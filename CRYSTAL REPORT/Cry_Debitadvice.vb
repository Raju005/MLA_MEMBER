...
Public Class Cry_Debitadvice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengal_MemberMaster.Cry_Debitadvice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Debitadvice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Debitadvice = New Cry_Debitadvice()
        rpt.Site = Me.Site
        Return rpt
    End Function
