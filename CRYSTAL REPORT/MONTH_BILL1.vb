...
Public Class MONTH_BILL1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengal_MemberMaster.MONTH_BILL1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMONTH_BILL1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MONTH_BILL1 = New MONTH_BILL1()
        rpt.Site = Me.Site
        Return rpt
    End Function
