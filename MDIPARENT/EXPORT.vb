...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.SELECT_GRID.Location = New System.Drawing.Point(40, 64)
        ...
        Me.SELECT_GRID.Size = New System.Drawing.Size(592, 304)
        Me.SELECT_GRID.TabIndex = 14
        '
        'EXPORT_GRID
        '
        Me.EXPORT_GRID.DataSource = Nothing
        Me.EXPORT_GRID.Location = New System.Drawing.Point(64, 528)
        ...
        Me.cmdexport.Location = New System.Drawing.Point(160, 376)
        Me.cmdexport.Name = "cmdexport"
        Me.cmdexport.Size = New System.Drawing.Size(192, 40)
        Me.cmdexport.TabIndex = 16
        Me.cmdexport.Text = "EXPORT TO  EXCEL [F7]"
        '
        'BTNCANCEL
        '
        ...
        Me.BTNCANCEL.Size = New System.Drawing.Size(184, 40)
        Me.BTNCANCEL.TabIndex = 17
        Me.BTNCANCEL.Text = "CANCEL [F11]"
        '
        'EXPORT
        '
...
#End Region
    ...
    Private Sub cmdexport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdexport.Click
        ...
        Try
            If SELECT_GRID.DataRowCnt > 0 Then
                sqlstring = "SELECT "
                SSQLSTR = " Update " & UCase(TABLENAME) & " set "
                With SELECT_GRID
                    For i = 1 To .DataRowCnt
                        ...
                        If Val(.Text) = 1 Then
                            ...
                            If Len(Trim(.Text)) > 0 Then
                                If DATATYPE = "STRING" Or DATATYPE = "CHAR" Or DATATYPE = "DATETIME" Or DATATYPE = "BYTE[]" Then
                                    sqlstring = sqlstring & " ISNULL(" & UCase(Trim(Trim(.Text))) & ",'') as " & UCase(Trim(Trim(.Text))) & " , "
                                    SSQLSTR = SSQLSTR & Trim(.Text) & " =ISNULL(" & UCase(Trim(Trim(.Text))) & ",'') , "
                                Else
                                    sqlstring = sqlstring & " ISNULL(" & UCase(Trim(Trim(.Text))) & ",0) as " & UCase(Trim(Trim(.Text))) & " , "
                                    SSQLSTR = SSQLSTR & Trim(.Text) & " =ISNULL(" & UCase(Trim(Trim(.Text))) & ",0) , "
                                End If
                            End If
                        End If
                    Next
    ...
    Private Sub BTNCANCEL_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNCANCEL.Click
        Me.Close()
    End Sub
    Private Sub SELECT_GRID_KeyDown(ByVal sender As Object, ByVal e As AxFPSpreadADO._DSpreadEvents_KeyDownEvent) Handles SELECT_GRID.KeyDownEvent
        Dim I As Integer
        Try
    ...
    Private Sub SELECT_GRID_Advance(ByVal sender As System.Object, ByVal e As AxFPSpreadADO._DSpreadEvents_AdvanceEvent) Handles SELECT_GRID.Advance
